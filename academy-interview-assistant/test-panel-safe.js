/**
 * Test script to manually show the candidate panel (CSP-safe version)
 * Works with Google Meet's Trusted Types policy
 */
...
name.className = 'academy-candidate-name';
name.textContent = mockCandidate.name;
